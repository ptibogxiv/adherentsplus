 ...
 */
class SubscriptionPlus extends CommonObject
{
  ...
  var $label;
	...
	function getNomUrl($withpicto=0)
	{
        ...
        $link = '<a href="'.dol_buildpath('/adherents/subscription/card.php?rowid='.$this->id.'', 1).'" title="'.dol_escape_htmltag($label, 1).'" class="classfortooltip">';
		$linkend='</a>';
