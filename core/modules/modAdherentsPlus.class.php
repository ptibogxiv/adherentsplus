...
class modAdherentsPlus extends DolibarrModules
{
    ...
    function __construct($db)
    {
        ...
        $this->version = '23.0.0';                        // 'experimental' or 'dolibarr' or version
       ...
       // Config pages. Put here list of php page, stored into oblyon/admin directory, to use to setup module.
    	...
    	'member:+options:Options:adherentsplus@adherentsplus:getDolGlobalInt("ADHERENT_CONSUMPTION"):/adherentsplus/member_options.php?rowid=__ID__',
    	'member:+consumption:Consumptions:adherentsplus@adherentsplus:getDolGlobalInt("ADHERENT_CONSUMPTION"):/adherentsplus/consumption.php?rowid=__ID__',
        'member:+linkedmember:LinkedMembers:adherentsplus@adherentsplus:getDolGlobalInt("ADHERENT_LINKEDMEMBER")/adherentsplus/linkedmember.php?rowid=__ID__',
        'membertype:+settings:TypeSettings:adherentsplus@adherentsplus:1:/adherentsplus/type_settings.php?rowid=__ID__',
        'membertype:+package:Package:adherentsplus@adherentsplus:getDolGlobalInt("ADHERENT_CONSUMPTION"):/adherentsplus/type_package.php?rowid=__ID__'
		);
