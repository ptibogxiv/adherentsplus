 ...
 */
class modAdherentEx extends DolibarrModules
{
    ...
    function __construct($db)
    {
        ...
        $this->description = "Management of members of a foundation or association Extended";
        ...
        // Config pages
        //-------------
        $this->config_page_url = array("adherent.php@adherentsex");
