...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $sall)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/adherentsplus/card.php?id='.$id.'', 1));
	exit;
}
...
{
	$newcardbutton='<a class="butActionNew" href="'.dol_buildpath('/adherentsplus/card.php?action=create', 1).'"><span class="valignmiddle text-plus-circle">'.$langs->trans('NewMember').'</span>';
